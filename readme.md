# 😘 CapsWriter-Offline 图形界面包分支 （ 仅 `<img src="./assets/windows-logo.png" width="25" height="25">` `<span style="color: #4ABAFF;">`Windows 10+

）

![alt text](assets/main.png)

# `<img src="./assets/windows-logo.png" width="25" height="25">` `<span style="color: #4ABAFF;">`Windows 端离线语音输入、中译英、字幕转录；在线多译多、云剪贴板
